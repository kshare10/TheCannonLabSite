  ...
  const sections = [
    {
      ...
      references: "See: Foy, N. J.; Forbes, K. C.; Crooke, A. M.; Gruber, M. D.; Cannon, J. S. Org. Lett. 2018, 20, 5727 and Forbes, K. C.; Crooke, A. M.; Lee, Y.; Kawada, M.; Shamskhou, K. M.; Zhang, R. A.; Cannon, J. S. J. Org. Chem. 2022, 87, 3498.",
    ...
    },
    {
      ...
      references: "See: Dwulet, N. C.; Zolfaghari, T. Z.; Brown, M. L.; Cannon, J. S. J. Org. Chem. 2018, 83, 11510",
    ...
    },
    {
      ...
      references: "See: Deardorff, D. R.; Niman, S. W.; Paulsen, M. I.; Sookezian, A.; Whalen, M. E.; Finlayson, C. J.; Frivold, C.; Brown, H. C.; Cannon, J. S. ACS Omega 2020, 5, 2005.",
        ...
        {sections.map((section, idx) => (
          <FadeIn key={idx} direction={idx % 2 === 0 ? "left" : "right"}>
            <div style={{ 
              ...
              flexWrap: 'wrap',
              paddingBottom: '5rem',
              borderBottom: idx !== sections.length - 1 ? '1px solid rgba(0, 229, 255, 0.15)' : 'none'
            }}>
